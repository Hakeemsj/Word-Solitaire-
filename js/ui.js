...
/* A peek is a narrow, non-interactive card sitting beside the front
   waste card, showing its whole word turned sideways so the player
   can see what's coming next — only the front card (a real .card) can
   actually be dragged or hinted. */
