...
const RELATIONS = [
  ...
  { id: "cat_sports", type: "Category", name: "Sports", words: ["soccer", "tennis", "swimming", "basketball", "boxing", "cycling", "running", "golf"] },
  ...
  { id: "ant_speed", type: "Antonym", name: "Speed", words: ["fast", "slow", "quick", "rapid", "gradual"] },
  ...
  { id: "ant_state", type: "Antonym", name: "State", words: ["open", "closed", "shut", "sealed", "ajar"] },
  { id: "ant_moisture", type: "Antonym", name: "Moisture", words: ["wet", "dry", "damp", "moist", "soggy"] },
  ...
  { id: "context_restaurant", type: "Context", name: "Restaurant", words: ["menu", "waiter", "bill", "order", "table", "tip"] },
  ...
  { id: "cat_birds", type: "Category", name: "Birds", words: ["eagle", "sparrow", "owl", "parrot", "penguin", "duck", "swan"] },
  ...
  { id: "cat_reptiles", type: "Category", name: "Reptiles", words: ["snake", "lizard", "turtle", "crocodile", "frog", "chameleon"] },
  ...
  { id: "cat_tools", type: "Category", name: "Tools", words: ["hammer", "screwdriver", "wrench", "saw", "drill", "pliers", "nail"] },
  { id: "cat_electronics", type: "Category", name: "Electronics", words: ["phone", "computer", "television", "camera", "tablet", "speaker", "router"] },
  { id: "cat_subjects", type: "Category", name: "Subjects", words: ["math", "science", "history", "geography", "art", "music", "biology"] },
  { id: "cat_stationery", type: "Category", name: "Stationery", words: ["pen", "pencil", "eraser", "ruler", "notebook", "scissors", "glue"] },
  { id: "cat_instruments", type: "Category", name: "Instruments", words: ["guitar", "piano", "violin", "drum", "flute", "trumpet", "saxophone"] },
  { id: "cat_appliances", type: "Category", name: "Appliances", words: ["fridge", "microwave", "toaster", "washer", "dryer", "vacuum", "iron"] },
  ...
  { id: "cat_flowers", type: "Category", name: "Flowers", words: ["rose", "tulip", "daisy", "sunflower", "lily", "orchid"] },
  { id: "cat_trees", type: "Category", name: "Trees", words: ["oak", "pine", "maple", "willow", "birch", "palm"] },
  { id: "cat_equipment", type: "Category", name: "Equipment", words: ["racket", "helmet", "goggles", "whistle", "net"] },
  { id: "cat_genres", type: "Category", name: "Genres", words: ["rock", "jazz", "reggae", "classical", "blues", "pop"] },
  ...
  { id: "cat_continents", type: "Category", name: "Continents", words: ["asia", "africa", "europe", "australia", "antarctica"] },
  ...
  { id: "cat_seafood", type: "Category", name: "Seafood", words: ["shrimp", "lobster", "salmon", "tuna", "oyster", "clam"] },
  ...
  { id: "cat_disasters", type: "Category", name: "Disasters", words: ["hurricane", "tornado", "earthquake", "flood", "drought"] },
  { id: "cat_organs", type: "Category", name: "Organs", words: ["heart", "brain", "lung", "liver", "kidney", "stomach"] },
  { id: "cat_computer", type: "Category", name: "Computer", words: ["keyboard", "mouse", "monitor", "printer", "charger"] },
  { id: "cat_bathroom", type: "Category", name: "Bathroom", words: ["towel", "soap", "shampoo", "toothbrush", "toothpaste", "razor"] },
  { id: "cat_baby", type: "Category", name: "Baby", words: ["diaper", "stroller", "crib", "bottle", "pacifier"] },
  { id: "cat_camping", type: "Category", name: "Camping", words: ["tent", "backpack", "compass", "flashlight", "lantern"] },
  { id: "cat_tech", type: "Category", name: "Tech", words: ["programmer", "designer", "analyst", "developer", "technician"] },
  { id: "cat_dance", type: "Category", name: "Dance", words: ["ballet", "salsa", "tango", "waltz"] },
  { id: "cat_currency", type: "Category", name: "Currency", words: ["dollar", "euro", "pound", "yen", "peso"] },
  { id: "cat_games", type: "Category", name: "Games", words: ["chess", "checkers", "puzzle", "dominoes", "dice"] },
  { id: "cat_materials", type: "Category", name: "Materials", words: ["wood", "plastic", "glass", "fabric", "leather", "rubber"] },
  { id: "cat_vehicles", type: "Category", name: "Vehicles", words: ["motorcycle", "truck", "van", "scooter", "tractor"] },
  ...
  { id: "syn_modern", type: "Synonym", name: "Modern", words: ["recent", "current", "contemporary", "updated"] },
  { id: "syn_wealthy", type: "Synonym", name: "Wealthy", words: ["rich", "affluent", "prosperous"] },
  { id: "syn_poor", type: "Synonym", name: "Poor", words: ["broke", "needy", "impoverished"] },
  ...
  { id: "syn_tidy", type: "Synonym", name: "Tidy", words: ["spotless", "neat", "pristine", "organized"] },
  ...
  { id: "ant_success", type: "Antonym", name: "Success", words: ["successful", "unsuccessful", "victorious", "defeated"] },
  ...
  { id: "func_shopping", type: "Function", name: "Shopping", words: ["buy", "sell", "trade", "exchange", "browse"] },
  { id: "func_learning", type: "Function", name: "Learning", words: ["study", "memorize", "practice", "research", "review"] },

  { id: "partof_plant", type: "PartOf", name: "Plant", words: ["root", "stem", "leaf", "petal", "seed", "branch"] },
  { id: "partof_book", type: "PartOf", name: "Book", words: ["cover", "page", "chapter", "title", "author"] },
  { id: "partof_shoe", type: "PartOf", name: "Shoe", words: ["sole", "lace", "heel", "tongue"] },
  ...
  { id: "activity_school", type: "Activity", name: "School", words: ["read", "write", "listen", "discuss"] },
  { id: "activity_exercise", type: "Activity", name: "Exercise", words: ["jog", "stretch", "lift", "squat"] },

  { id: "context_wedding", type: "Context", name: "Wedding", words: ["bride", "groom", "ring", "veil", "bouquet"] },
  ...
  { id: "context_bank", type: "Context", name: "Bank", words: ["deposit", "withdraw", "account", "teller", "loan"] },
